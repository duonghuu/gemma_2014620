...
function get_main_khachhang()
{
    global $d;
      ...
      $str='<select id="id_khachhang" name="id_khachhang" onchange="select_onchange1()" class="main_select select_danhmuc">
...
<form name="supplier" id="validate" class="form" action="index.php?com=product&act=save&p=<?=$_REQUEST['p']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
 <div class="widget">
   ...
   <div class="formRow">
    <label>Họ tên:</label>
    <div class="formRight">
      <input type="text" name="data[ten]" id="ten" value="<?=($get_khachhang['ten'])?$get_khachhang['ten']:$item['ten']?>" class="input" />
    </div>
    <div class="clear"></div>
   </div>
   <div class="formRow">
    <label>Email:</label>
    <div class="formRight">
      <input type="text" name="email" id="email" value="<?=($get_khachhang['email'])?$get_khachhang['email']:$item['email']?>" class="input" />
    </div>
    <div class="clear"></div>
   </div>
   <div class="formRow">
